...
public class CheckNovostiLoraShen extends TestInit {
    LandingPageLoraShen landingPageLoraShen;
    @Test
    public void kashpoDlyRoslin() {
        landingPageLoraShen = new LandingPageLoraShen(driver);
        driver.get("https://lorashen.ua/shop");
        landingPageLoraShen.novostiFooterLoraShen().click();
        Assert.assertTrue(driver.getCurrentUrl().contains("novosti"));
    }
}
