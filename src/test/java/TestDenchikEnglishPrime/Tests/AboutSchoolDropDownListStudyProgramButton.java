...
public class AboutSchoolDropDownListStudyProgramButton extends TestInit {
    LandingPageEnglishPrime landingPageEnglishPrime;
    @Test
    public void aboutSchoolDropDownListStudyProgramButton(){
        ...
        landingPageEnglishPrime.aboutSchoolDropDownListStudyProgramButton().click();
        Assert.assertTrue(driver.getCurrentUrl().contains("main-program"));
    }
}
