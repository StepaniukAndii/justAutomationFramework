...
public class CoursesDropDownListIntensiveCourseButton extends TestInit {
    LandingPageEnglishPrime landingPageEnglishPrime;
    @Test
    public void coursesDropDownListIntensiveCourseButton(){
        ...
        landingPageEnglishPrime.coursesDropDownListIntensiveCourseButton().click();
        Assert.assertTrue(driver.getCurrentUrl().contains("intensiv"));
    }
}
