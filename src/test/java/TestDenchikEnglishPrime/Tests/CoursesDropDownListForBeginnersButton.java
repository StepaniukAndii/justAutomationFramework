...
public class CoursesDropDownListForBeginnersButton extends TestInit {
    LandingPageEnglishPrime landingPageEnglishPrime;
    @Test
    public void coursesDropDownListForBeginnersButton(){
        ...
        landingPageEnglishPrime.coursesDropDownListForBeginnersButton().click();
        Assert.assertTrue(driver.getCurrentUrl().contains("english-language-for-beginners-kiev"));
    }
}
