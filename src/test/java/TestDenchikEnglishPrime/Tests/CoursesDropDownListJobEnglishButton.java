...
public class CoursesDropDownListJobEnglishButton extends TestInit {
    LandingPageEnglishPrime landingPageEnglishPrime;
    @Test
    public void coursesDropDownListJobEnglish(){
        ...
        landingPageEnglishPrime.coursesDropDownListJobEnglishButton().click();
        Assert.assertTrue(driver.getCurrentUrl().contains("kursy-korporativnogo-anglijskogo"));
    }
}
