...
public class CoursesDropDownListPrepearingForZNOButton extends TestInit {
    LandingPageEnglishPrime landingPageEnglishPrime;
    @Test
    public void coursesDropDownListPrepearingForZNOButton(){
        ...
        landingPageEnglishPrime.coursesDropDownListPrepearingForZNOButton().click();
        Assert.assertTrue(driver.getCurrentUrl().contains("podgotovka-k-zno-po-anglijskomu-yazyku"));
    }
}
