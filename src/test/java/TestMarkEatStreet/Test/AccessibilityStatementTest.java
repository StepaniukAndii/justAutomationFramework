...
public class AccessibilityStatementTest extends TestInit{
    Footer footer;
    DriverPage driverPage;
    @Test
    public void accessibilitystat(){
        footer = new Footer(driver);
        driverPage = new DriverPage(driver);
        openUrl("https://qa2.eatstreet.com/");
        driverPage.gotitbtn().click();
        footer.accessibilitystatementbtn().click();
        Boolean wait = new WebDriverWait(driver, 10).
                until(ExpectedConditions.urlToBe("https://qa2.eatstreet.com/accessibility"));
