...
public class CartNegetivTestAttemptToPay extends TestInit {
    @Test
    public void cartNegetivTestAttemptToPay(){
        ...
        OrderDatailsPage orderDatailsPage=new OrderDatailsPage(driver);
        orderDatailsPage.enterFirtName().sendKeys("Svetlana");
        sleep(5);
        orderDatailsPage.enterLastName().sendKeys("Prutas");
        sleep(3);
        orderDatailsPage.enterPhoneNumber().sendKeys("+380936431820");
        Assert.assertTrue(orderDatailsPage.checkOrderDatails().isDisplayed());
    }
}
